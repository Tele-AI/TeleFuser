"""Bounded latest-wins scheduling for LingBot-VLA v2 action chunks."""
...
class ActionChunkScheduler:
    """Serialize GPU inference while retaining only the newest pending chunk per session."""
    ...
    async def start(self) -> None:
        ...
        self._worker = asyncio.create_task(self._run(), name="lingbot-vla-v2-action-scheduler")
