...
from telefuser.models.ltx25.diff_vae.transformer.det_attn_rope import det_qkv_rope
from telefuser.models.ltx25.diff_vae.transformer.qkv import QKVProjections
from telefuser.models.ltx25.diff_vae.transformer.rope_math import (
    DEFAULT_ABS_ROPE_NUM_TILES,
    default_rope_dim_split,
    rope_inv_freqs,
)
from telefuser.ops.neighborhood_attention import natten_available, neighborhood_attention_3d
...
class NattenAttention(NAAttentionCallable):
    ...
    def __call__(
        ...
        return neighborhood_attention_3d(q, k, v, kernel_size=attn.kernel_size, backend=self._backend)
