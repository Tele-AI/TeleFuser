...
from telefuser.models.ltx25.diff_vae.transformer.fallback_na.eager import na3d as eager_na3d

if TYPE_CHECKING:
    from telefuser.models.ltx25.diff_vae.transformer.attention import NAAttentionCallable, NeighborhoodAttention3D
...
def na_attention_triton(
    ...
    from telefuser.models.ltx25.diff_vae.transformer.fallback_na.triton_na import (  # noqa: PLC0415
        na3d as triton_na3d,
    )
