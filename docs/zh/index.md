...
- **[TeleFuser 与 AIPerf Benchmark](benchmark_aiperf.md)** — Batch、stream、baseline 与 GreptimeDB 历史服务入口
- **[当前 Benchmark 对比快照](benchmark_current_comparison.md)** — 当前实测结果、baseline 状态和对比结论
- **[TeleFuser 与 AIPerf Benchmark 设计](benchmark_aiperf_design.md)** — 对标分层、观测协议、GreptimeDB 历史层和固定 workload 设计
